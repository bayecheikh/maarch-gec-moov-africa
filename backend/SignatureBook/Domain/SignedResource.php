...
class SignedResource implements JsonSerializable, HasSignatureInterface
{
    private int $id = -1;
    ...
    {
        return $this->externalState['hasStampSignature'] ?? null;
    }

    public function getHasDigitalSignature(): ?bool
    {
        return $this->externalState['hasDigitalSignature'] ?? null;
    }
