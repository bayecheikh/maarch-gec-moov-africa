...
/**
 * @brief Contact Postal Address Is Not Complete Enough Problem class
...
class ContactPostalAddressIsNotCompleteEnoughProblem extends Problem
{
    public function __construct(ContactInterface $contact)
    {
        parent::__construct(
            ...
            'contactPostalAddressIsNotCompleteEnough'
        );
    }
}
