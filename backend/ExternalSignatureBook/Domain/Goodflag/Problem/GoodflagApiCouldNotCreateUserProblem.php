...
/**
 * @brief Goodflag Api Could Not Create User Problem class
...
class GoodflagApiCouldNotCreateUserProblem extends Problem
{
    public function __construct(string $detail, int $status)
    {
        parent::__construct(
            _GOODFLAG_API_COULD_NOT_CREATE_USER_ . " : $detail",
            $status,
            [
                'error' => $detail
            ],
            'goodflagApiCouldNotCreateUser'
        );
    }
}
