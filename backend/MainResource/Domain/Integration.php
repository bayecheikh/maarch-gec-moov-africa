...
class Integration
{
    ...
    {
        return $this->inMailevaShipping;
    }

    public function setInMailevaShipping(bool $inMailevaShipping): Integration
    {
        $this->inMailevaShipping = $inMailevaShipping;
        return $this;
    }
}
