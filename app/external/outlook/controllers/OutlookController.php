...
class OutlookController
{
    ...
    public function generateManifest(Request $request, Response $response)
    {
        ...
        $manifestTemplate = file_get_contents('dist-addin/assets/manifest.xml.default');
    ...
    public function getConfiguration(Request $request, Response $response): Response
    {
        ...
        $configuration['value']['tenantId'] = !empty($configuration['value']['tenantId']) ?
            PasswordController::decrypt(['encryptedData' => $configuration['value']['tenantId']]) : '';
        $configuration['value']['clientId'] = !empty($configuration['value']['clientId']) ?
            PasswordController::decrypt(['encryptedData' => $configuration['value']['clientId']]) : '';
        $configuration['value']['clientSecret'] = !empty($configuration['value']['clientSecret']) ?
