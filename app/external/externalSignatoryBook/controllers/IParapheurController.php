...
class IParapheurController
{
     ...
     * @throws Exception
     */
    public static function returnCurl(string $xmlPostString, array $config): array
    {
        $option = [
     ...
     * @throws Exception
     */
    public static function upload(array $aArgs): array
    {
     ...
     * @throws Exception
     */
    public static function uploadFile(array $aArgs): array
    {
        ...
        $xmlPostString = '<?xml version="1.0" encoding="utf-8"?>
            ...
            ' xmlns:ns="http://www.adullact.org/spring-ws/iparapheur/1.0" xmlns:xm="http://www.w3.org/2005/05/xmlmime">
                               <soapenv:Header/>
                               <soapenv:Body>
                                  <ns:CreerDossierRequest>
                                     <ns:TypeTechnique>' . $aArgs['config']['data']['defaultType'] .
            '</ns:TypeTechnique>
                                     ...
                                     <ns:DocumentPrincipal xm:contentType="application/pdf">' . $b64Attachment .
     ...
     * @throws Exception
     */
    public static function download(array $aArgs): array
    {
        $xmlPostString = '<?xml version="1.0" encoding="utf-8"?>
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"' .
     ...
     * @throws Exception
     */
    public static function retrieveSignedMails(array $aArgs): mixed
    {
     ...
     * @throws Exception
     */
    public static function getType(array $aArgs): array|bool
    {
        $xmlPostString = '<?xml version="1.0" encoding="utf-8"?>
           <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"' .
            ' xmlns:ns="http://www.adullact.org/spring-ws/iparapheur/1.0">
     ...
     * @throws Exception
     */
    public static function getSousType(array $aArgs): mixed
    {
        $xmlPostString = '<?xml version="1.0" encoding="utf-8"?>
           <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"' .
            ' xmlns:ns="http://www.adullact.org/spring-ws/iparapheur/1.0">
               <soapenv:Header/>
               <soapenv:Body>
                  <ns:GetListeSousTypesRequest>' . $aArgs['config']['data']['defaultType'] .
