...
class AttachmentTypeController
{
    ...
    public function get(Request $request, Response $response): Response
    {
        ...
        foreach ($rawAttachmentsTypes as $rawAttachmentsType) {
            $attachmentsTypes[$rawAttachmentsType['type_id']] = [
                ...
                'inSignatureBook'   => $rawAttachmentsType['in_signatory_book_default'],
            ];
        }
    ...
    public function getById(Request $request, Response $response, array $args): Response
    {
        ...
        $attachmentType = [
            ...
            'inSignatureBook'   => $attachmentType['in_signatory_book_default']
        ];
    ...
    public function create(Request $request, Response $response): Response
    {
        ...
        $id = AttachmentTypeModel::create([
            ...
            'in_signatory_book_default' => empty($body['inSignatureBook']) ? 'false' : 'true'
        ]);
    ...
    public function update(Request $request, Response $response, array $args): Response
    {
        ...
        if (isset($body['inSignatureBook'])) {
            $set['in_signatory_book_default'] = empty($body['inSignatureBook']) ? 'false' : 'true';
        }
        if (
            $set['visible'] == 'true' &&
