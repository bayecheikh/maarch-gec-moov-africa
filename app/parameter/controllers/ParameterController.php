...
class ParameterController
{
    ...
    public function create(Request $request, Response $response): Response
    {
        ...
        if (str_contains($data['id'], 'chrono_')) {
    ...
    public function update(Request $request, Response $response, array $args): Response
    {
        ...
        if (in_array($args['id'], ['logo', 'bodyImage'])) {
            ...
            if ($args['id'] == 'logo') {
                if (!str_contains($body['image'], 'data:image/svg+xml;base64,')) {
                ...
                if (!str_contains($body['image'], 'data:image/jpeg;base64,')) {
            ...
            if ($args['id'] === 'maarchUrl') {
                $body[$args['id']] = rtrim($body[$args['id']], "/");
            }
            ...
            if (empty($parameter)) {
                ...
                if (str_contains($args['id'], 'chrono_')) {
            ...
            if (str_contains($body['id'], 'chrono_')) {
    ...
    public function delete(Request $request, Response $response, array $aArgs): Response
    {
        ...
        if (str_contains($aArgs['id'], 'chrono_')) {
