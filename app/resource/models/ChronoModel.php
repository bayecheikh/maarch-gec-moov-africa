...
class ChronoModel
{
     ...
     * @throws Exception
     */
    public static function getChronoEntity(string $entityId): string
    {
     ...
     * @throws Exception
     */
    public static function getChronoCategory(string $categoryId): string
    {
     ...
     * @return string
     */
    public static function getChronoCategoryChar(string $categoryId): string
    {
