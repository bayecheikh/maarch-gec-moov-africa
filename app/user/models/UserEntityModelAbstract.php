...
abstract class UserEntityModelAbstract
{
     ...
     * @throws Exception
     */
    public static function getUsersWithoutEntities(array $aArgs): array
    {
        ValidatorModel::arrayType($aArgs, ['select', 'where', 'data']);

        $where = $aArgs['where'] ?? [];
        $where[] = 'users_entities IS NULL';
        $where[] = 'status != ?';
     ...
     * @throws Exception
     */
    public static function addUserEntity(array $args): bool
    {
     ...
     * @throws Exception
     */
    public static function updateUserEntity(array $args): bool
    {
     ...
     * @throws Exception
     */
    public static function updateUserPrimaryEntity(array $aArgs): bool
    {
     ...
     * @throws Exception
     */
    public static function reassignUserPrimaryEntity(array $aArgs): bool
    {
     ...
     * @throws Exception
     */
    public static function deleteUserEntity(array $aArgs): bool
    {
        ValidatorModel::notEmpty($aArgs, ['id', 'entityId']);
        ValidatorModel::intVal($aArgs, ['id']);
        ValidatorModel::stringType($aArgs, ['entityId']);
     ...
     * @throws Exception
     */
    public static function getWithUsers(array $aArgs): array
    {
        ValidatorModel::notEmpty($aArgs, ['select', 'where', 'data']);
