...
class AdrModel
{
     ...
     * @throws Exception
     */
    public static function getConvertedDocumentById(array $aArgs): array
    {
     ...
     * @throws Exception
     */
    public static function getTypedAttachAdrByResId(array $aArgs): array
    {
     ...
     * @throws Exception
     */
    public static function createDocumentAdr(array $args): bool
    {
        ...
        ValidatorModel::boolType($args, ['is_annotated']);
        ...
        DatabaseModel::insert([
            ...
            'columnsValues' => [
                ...
                'is_annotated' => !isset($args['is_annotated']) || !$args['is_annotated'] ? 'false' : 'true',
            ]
        ]);
     ...
     * @throws Exception
     */
    public static function createAttachAdr(array $aArgs): bool
    {
     ...
     * @throws Exception
     */
    public static function updateDocumentAdr(array $args): bool
    {
     ...
     * @throws Exception
     */
    public static function updateAttachmentAdr(array $args): bool
    {
        ValidatorModel::notEmpty($args, ['set', 'where', 'data']);
        ValidatorModel::arrayType($args, ['set', 'where', 'data']);
     ...
     * @throws Exception
     */
    public static function deleteDocumentAdr(array $args): bool
    {
     ...
     * @throws Exception
     */
    public static function deleteAttachmentAdr(array $args): bool
    {
        ValidatorModel::notEmpty($args, ['where', 'data']);
        ValidatorModel::arrayType($args, ['where', 'data']);
