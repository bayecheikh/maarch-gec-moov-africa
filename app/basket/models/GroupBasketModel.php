...
class GroupBasketModel
{
     ...
     * @throws Exception
     */
    public static function createGroupBasket(array $args): bool
    {
     ...
     * @throws Exception
     */
    public static function deleteGroupBasket(array $aArgs): bool
    {
     ...
     * @throws Exception
     */
    public static function getBasketsByGroupId(array $aArgs): array
    {
