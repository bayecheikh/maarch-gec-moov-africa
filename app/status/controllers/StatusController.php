...
class StatusController
{
     ...
     * @throws Exception
     */
    public function getByIdentifier(Request $request, Response $response, array $aArgs): Response
    {
        if (!PrivilegeController::hasPrivilege(['privilegeId' => 'admin_status', 'userId' => $GLOBALS['id']])) {
            return $response->withStatus(403)->withJson(['errors' => 'Service forbidden']);
        }
     ...
     * @return array
     */
    protected static function manageValue(array $request): array
    {
     ...
     * @throws Exception
     */
    protected function control(array $request, string $mode): array
    {
        $errors = [];
