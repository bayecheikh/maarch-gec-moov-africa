...
class DiffusionTypesController
{
     ...
     * @throws Exception
     */
    public static function getRecipientsByCopie(array $args = []): array|int|null
    {
        if ($args['request'] == 'recipients') {
     ...
     * @throws Exception
     */
    public static function getRecipientsByDestEntity(array $args = []): array|int|null
    {
        if ($args['request'] == 'recipients') {
            return DatabaseModel::select([
     ...
     * @throws Exception
     */
    public static function getRecipientsByDestUserSign(array $args = []): array|int|null
    {
        if ($args['request'] == 'recipients') {
            $table = ['listinstance li', 'users us'];
            $leftJoin = ['li.item_id = us.id'];
     ...
     * @throws Exception
     */
    public static function getRecipientsByDestUserVisa(array $args = []): array|int|null
    {
        if ($args['request'] == 'recipients') {
            $table = ['listinstance li', 'users us'];
            $leftJoin = ['li.item_id = us.id'];
     ...
     * @throws Exception
     */
    public static function getRecipientsByDestUser(array $args = []): array|int|null
    {
        if ($args['request'] == 'recipients') {
            $table = ['listinstance li', 'users us'];
            $leftJoin = ['li.item_id = us.id'];
