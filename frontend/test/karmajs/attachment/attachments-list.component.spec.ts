...
describe('AttachmentsListComponent', () => {
    ...
    function loadAttachments() {
        const attachmentsTypesMock: Record<string, AttachmentTypeInterface> = {
            response_project: {
                typeId: new UntypedFormControl('response_project'),
                label: new UntypedFormControl('Projet de réponse'),
                visible: new UntypedFormControl(true),
                emailLink: new UntypedFormControl(true),
                signable: new UntypedFormControl(true),
                signedByDefault: new UntypedFormControl(false),
                icon: new UntypedFormControl('R'),
                chrono: new UntypedFormControl(true),
                versionEnabled: new UntypedFormControl(true),
                newVersionDefault: new UntypedFormControl(true),
                inSignatureBook: new UntypedFormControl(false)
            },
            simple_attachment: {
                typeId: new UntypedFormControl('simple_attachment'),
                label: new UntypedFormControl('Pièce jointe'),
                visible: new UntypedFormControl(true),
                emailLink: new UntypedFormControl(true),
                signable: new UntypedFormControl(false),
                signedByDefault: new UntypedFormControl(false),
                icon: new UntypedFormControl('PJ'),
                chrono: new UntypedFormControl(true),
                versionEnabled: new UntypedFormControl(false),
                newVersionDefault: new UntypedFormControl(false),
                inSignatureBook: new UntypedFormControl(false)
            }
        };

        const filterAttachTypesMock: { id: string, label: string }[] = [
            {
                id: 'response_project',
        ...
        Object.keys(attachmentsTypesMock).forEach((type: any) => {
            component.attachmentTypes.push({
                typeId: attachmentsTypesMock[type].typeId.value,
                signable: attachmentsTypesMock[type].signable.value
            });
        });
