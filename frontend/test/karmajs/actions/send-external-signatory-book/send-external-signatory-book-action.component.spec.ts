...
} from "@appRoot/actions/send-external-signatory-book-action/send-external-signatory-book-action.component";
...
describe('SendExternalSignatoryBookActionComponent', () => {
    ...
    beforeEach(fakeAsync(() => {
        TestBed.inject(AuthService).externalSignatoryBook = {
            id: 'iParapheur',
            from: 'pastell',
        ...
        component.data = {
            ...
            resource: {
                ...
                resId: 100, chrono: 'MAARCH/2023A/1', subject: 'Courrier de test', integrations: { inSignatureBook: true }
            },
            userId: 19
        };
    }));
    ...
    describe('Load external signatory book id and set attachments', () => {
        it('Set attachments and show integrationTarget filter', fakeAsync(() => {
            spyOn(component.externalSignatoryBook, 'checkExternalSignatureBook').and.returnValue(Promise.resolve({
                availableResources: [],
                additionalsInfos: { attachments: [], noAttachment: [] },
                errors: []
            }));
...
function loadAttachments(component: SendExternalSignatoryBookActionComponent, fixture: ComponentFixture<SendExternalSignatoryBookActionComponent>) {
    ...
    component.attachmentsList.attachmentTypes = setAttachmentTypes();
...
function setAttachmentTypes() {
    return [
        ...
        {
            "typeId": "acknowledgement_record_management",
            "signable": false,
            "signedByDefault": false
        },
        {
            "typeId": "reply_record_management",
            "signable": false,
            "signedByDefault": false
        },
        {
            "typeId": "shipping_deposit_proof",
            "signable": false,
            "signedByDefault": false
        },
        {
            "typeId": "shipping_acknowledgement_of_receipt",
            "signable": false,
            "signedByDefault": false
        },
        {
        ...
        {
            "typeId": "incoming_mail_attachment",
            "signable": false,
            "signedByDefault": false
        },
        {
            "typeId": "outgoing_mail",
            "signable": true,
            "signedByDefault": false
        },
        {
