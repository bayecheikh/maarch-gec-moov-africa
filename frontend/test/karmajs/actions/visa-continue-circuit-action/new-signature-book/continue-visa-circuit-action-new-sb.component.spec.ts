...
} from "@appRoot/actions/visa-continue-circuit-action/new-signature-book/continue-visa-circuit-action-new-sb.component";
...
describe('ContinueVisaCircuitActionNewSbComponent', (() => {
    ...
    describe('CheckSignatureBook and set resources to sign', (() => {
        it('should call checkSignatureBook API, return resourcesInformations and set resources to sign', fakeAsync(() => {
            ...
            const req = httpTestingController.expectOne(`../rest/resourcesList/users/${component.data.userId}/groups/${component.data.groupId}/baskets/${component.data.basketId}/actions/${component.data.action.id}/checkContinueVisaCircuit?applyStampEnabled=${component.parameters.stampSelection}`);
            ...
            spyOn(component, 'checkSignatureBook').and.returnValue(Promise.resolve(true));
            spyOn(component.signatureBookService, 'getUserSignatures').and.returnValue(Promise.resolve([]));
            spyOn(component.signatureBookService, 'getTimestampConfig').and.returnValue(Promise.resolve({
                using: 'timestampServer',
                autoApply: false,
                enabled: true
            }));

            spyOn(component, 'canShowDigitalCertificate').and.returnValue(true);
            spyOn(component, 'canShowTimestamp').and.returnValue(true);
            ...
            expect(containerTitle.innerHTML.trim()).toEqual('4 document(s) à viser/signer');
            ...
            const timestampCheckbox = nativeElement.querySelector('mat-checkbox[name="timestamp"]');
            const digitalCertificate = nativeElement.querySelector('mat-checkbox[name="digitalCertificate"]');

            expect(timestampCheckbox).toBeDefined();
            expect(digitalCertificate).toBeDefined();

            expect(Boolean(timestampCheckbox.attributes['ng-reflect-checked'].value)).toBeTrue();

            digitalCertificate.click();
            ...
            expect(Boolean(timestampCheckbox.attributes['ng-reflect-checked'].value)).toBeTrue();
            expect(Boolean(digitalCertificate.attributes['ng-reflect-disabled'].value)).toBeTrue();
        }));
    }));
}));
...
function setDatas(component: ContinueVisaCircuitActionNewSbComponent): void {
    component.data = {
        ...
        groupId: 2,
        basketId: 16,
        action: { ...component.data.action, id: 410, label: 'Valider et poursuivre le circuit de visa' },
        resIds: [146],
        resource: {
            ...
            docsToSign: [
                {
                    ...
                    "canConvert": true,
                    "canDelete": false,
                    "resourceUrn": `rest/attachment/56/content\``,
                    "isAttachment": true,
                    ...
                    "stamps": [
                        {
                            "base64Image": "iVBORw0KGgoBBBNSUhEUgAAAVAAAABKCAYAAADt0gyQAAAgAElEQVR4nOydd5RUVbq3687M1euMcyeq11HHUUFAx...",
                            "width": 36,
                            "height": 9,
                ...
                },
                {
                    ...
                    "canUpdate": false,
                    "canConvert": true,
                    "resourceUrn": `rest/attachment/57/content\``,
                    "isAttachment": true,
                    "externalDocumentId": null,
                    "fileInformation": {
                        typistId: 19,
                ...
                },
                {
                    ...
                    "canUpdate": false,
                    "canConvert": true,
                    "resourceUrn": `rest/attachment/59/content\``,
                    "isAttachment": true,
                    "externalDocumentId": null,
                    "fileInformation": {
                        typistId: 19,
                ...
                },
                {
                    ...
                    "isConverted": true,
                    "canConvert": true,
                    "resourceUrn": `rest/attachment/58/content\``,
                    "isAttachment": true,
                    "externalDocumentId": null,
                    "fileInformation": {
                        typistId: 19,
                    ...
                    "stamps": [
                        {
                            "base64Image": "iVBORw0KGgoAAAANSUhEUgAAAVAAAABKCAYAAADt0gyQAAAgAElEQVR4nOydd5RUVbq3687M1euMcyeq11HHUUFAx...",
