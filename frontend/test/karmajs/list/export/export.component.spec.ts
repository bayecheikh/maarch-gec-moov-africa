...
describe('ExportComponent', () => {
    ...
    describe('Resources, delimiter and format', () => {
        ...
        it('select some elements and export as CSV', fakeAsync(() => {
            // Setup for CSV export
            component.exportModel.resources = [101, 102];
            component.exportModel.format = 'csv';
            ...
            // Create CSV blob
            const csvContent = 'id,object,date\n101,Document 1,2023-01-01\n102,Document 2,2023-01-02';
