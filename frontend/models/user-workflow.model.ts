import { DatePositionInterface } from "./date-position.model";
...
export interface UserWorkflowInterface {
     ...
     * Date positions
     */
    datePositions?: DatePositionInterface[];
    ...
    /**
     * Represents the increment or step value
     */
    step?: number;

    /**
     * Indicates whether a signature is required for a specific operation or process.
     */
    isSignatureRequired?: boolean;

    isSystem?: boolean;

    externalSignatureBookStatus?: string;
