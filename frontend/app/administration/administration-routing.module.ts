...
} from './contact/parameter/contacts-parameters-administration.component';
...
} from './contact/customField/contacts-custom-fields-administration.component';
...
} from './organizationEmailSignatures/organization-email-signatures-administration.component';
...
import { FolderAdministrationComponent } from './folder/folder-administration.component';
import { ProConnectAdministrationComponent } from './connection/proConnect/proconnect-administration.component';
import {
    GoodflagListAdministrationComponent
} from "@appRoot/administration/goodflag/list/goodflag-list-administration.component";
...
@NgModule({
    imports: [
        RouterModule.forChild([
            ...
            {
                path: 'administration/baskets/new',
                canActivate: [AppGuardAdmin],
                component: BasketAdministrationComponent
            },
            {
                path: 'administration/baskets/:id',
                canActivate: [AppGuardAdmin],
                component: BasketAdministrationComponent
            },
            { path: 'administration/doctypes', canActivate: [AppGuardAdmin], component: DoctypesAdministrationComponent },
            {
                path: 'administration/diffusionModels',
                canActivate: [AppGuardAdmin],
                component: DiffusionModelsAdministrationComponent
            },
            {
                path: 'administration/diffusionModels/new',
                canActivate: [AppGuardAdmin],
                component: DiffusionModelAdministrationComponent
            },
            {
                path: 'administration/diffusionModels/:id',
                canActivate: [AppGuardAdmin],
                component: DiffusionModelAdministrationComponent
            },
            ...
            {
                path: 'administration/statuses/new',
                canActivate: [AppGuardAdmin],
                component: StatusAdministrationComponent
            },
            {
                path: 'administration/statuses/:identifier',
                canActivate: [AppGuardAdmin],
                component: StatusAdministrationComponent
            },
            {
                ...
                canActivate: [AppGuardAdmin],
                component: ParametersAdministrationComponent
            },
            {
                path: 'administration/parameters/new',
                canActivate: [AppGuardAdmin],
                component: ParameterAdministrationComponent
            },
            {
                path: 'administration/parameters/:id',
                canActivate: [AppGuardAdmin],
                component: ParameterAdministrationComponent
            },
            {
                ...
                canActivate: [AppGuardAdmin],
                component: PrioritiesAdministrationComponent
            },
            {
                path: 'administration/priorities/new',
                canActivate: [AppGuardAdmin],
                component: PriorityAdministrationComponent
            },
            {
            ...
            {
                path: 'administration/actions/new',
                canActivate: [AppGuardAdmin],
                component: ActionAdministrationComponent
            },
            {
            ...
            },
            {
                ...
                canActivate: [AppGuardAdmin],
                component: NotificationsAdministrationComponent
            },
            {
                path: 'administration/notifications/new',
                canActivate: [AppGuardAdmin],
                component: NotificationAdministrationComponent
            },
            {
                path: 'administration/notifications/:identifier',
                canActivate: [AppGuardAdmin],
                component: NotificationAdministrationComponent
            },
            { path: 'administration/history', canActivate: [AppGuardAdmin], component: HistoryAdministrationComponent },
            {
                path: 'administration/history-batch',
                canActivate: [AppGuardAdmin],
                component: HistoryBatchAdministrationComponent
            },
            {
                path: 'administration/update-status',
                canActivate: [AppGuardAdmin],
                component: UpdateStatusAdministrationComponent
            },
            {
                path: 'administration/contacts',
                canActivate: [AppGuardAdmin],
                component: ContactsListAdministrationComponent
            },
            {
                path: 'administration/contacts/duplicates',
                canActivate: [AppGuardAdmin],
                component: ContactDuplicateComponent
            },
            { path: 'administration/contacts/list', redirectTo: 'contacts', pathMatch: 'full' },
            {
                path: 'administration/contacts/list/new',
                canActivate: [AppGuardAdmin],
                component: ContactsPageAdministrationComponent
            },
            {
                path: 'administration/contacts/list/:id',
                canActivate: [AppGuardAdmin],
                component: ContactsPageAdministrationComponent
            },
            {
                path: 'administration/contacts/contactsCustomFields',
                canActivate: [AppGuardAdmin],
                component: ContactsCustomFieldsAdministrationComponent
            },
            {
                path: 'administration/contacts/contacts-groups',
                canActivate: [AppGuardAdmin],
                component: ContactsGroupsAdministrationComponent
            },
            {
                path: 'administration/contacts/contacts-groups/new',
                canActivate: [AppGuardAdmin],
                component: ContactsGroupAdministrationComponent
            },
            {
                path: 'administration/contacts/contacts-groups/:id',
                canActivate: [AppGuardAdmin],
                component: ContactsGroupAdministrationComponent
            },
            {
                path: 'administration/contacts/contacts-parameters',
                canActivate: [AppGuardAdmin],
                component: ContactsParametersAdministrationComponent
            },
            {
                path: 'administration/versions-update',
                canActivate: [AppGuardAdmin],
                component: VersionsUpdateAdministrationComponent
            },
            {
                path: 'administration/docservers',
                canActivate: [AppGuardAdmin],
                component: DocserversAdministrationComponent
            },
            {
                path: 'administration/docservers/new',
                canActivate: [AppGuardAdmin],
                component: DocserverAdministrationComponent
            },
            {
                path: 'administration/templates',
                canActivate: [AppGuardAdmin],
                component: TemplatesAdministrationComponent
            },
            {
                path: 'administration/templates/new',
                canActivate: [AppGuardAdmin],
                component: TemplateAdministrationComponent
            },
            {
                path: 'administration/templates/:id',
                canActivate: [AppGuardAdmin],
                component: TemplateAdministrationComponent
            },
            {
                path: 'administration/securities',
                canActivate: [AppGuardAdmin],
                component: SecuritiesAdministrationComponent
            },
            { path: 'administration/sendmail', canActivate: [AppGuardAdmin], component: SendmailAdministrationComponent },
            {
                path: 'administration/organizationEmailSignatures',
                canActivate: [AppGuardAdmin],
                component: OrganizationEmailSignaturesAdministrationComponent
            },
            {
                path: 'administration/shippings',
                canActivate: [AppGuardAdmin],
                component: ShippingsAdministrationComponent
            },
            {
                path: 'administration/shippings/new',
                canActivate: [AppGuardAdmin],
                component: ShippingAdministrationComponent
            },
            {
                path: 'administration/shippings/:id',
                canActivate: [AppGuardAdmin],
                component: ShippingAdministrationComponent
            },
            {
                path: 'administration/customFields',
                canActivate: [AppGuardAdmin],
                component: CustomFieldsAdministrationComponent
            },
            {
                path: 'administration/indexingModels',
                canActivate: [AppGuardAdmin],
                component: IndexingModelsAdministrationComponent
            },
            {
                path: 'administration/indexingModels/new',
                canActivate: [AppGuardAdmin],
                component: IndexingModelAdministrationComponent
            },
            {
                path: 'administration/indexingModels/:id',
                canActivate: [AppGuardAdmin],
                component: IndexingModelAdministrationComponent
            },
            ...
            { path: 'administration/tags/:id', canActivate: [AppGuardAdmin], component: TagAdministrationComponent },
            {
                ...
                canActivate: [AppGuardAdmin],
                component: AlfrescoListAdministrationComponent
            },
            {
                path: 'administration/alfresco/new',
                canActivate: [AppGuardAdmin],
                component: AlfrescoAdministrationComponent
            },
            {
                path: 'administration/alfresco/:id',
                canActivate: [AppGuardAdmin],
                component: AlfrescoAdministrationComponent
            },
            {
                path: 'administration/multigest',
                canActivate: [AppGuardAdmin],
                component: MultigestListAdministrationComponent
            },
            {
                path: 'administration/multigest/new',
                canActivate: [AppGuardAdmin],
                component: MultigestAdministrationComponent
            },
            {
                path: 'administration/multigest/:id',
                canActivate: [AppGuardAdmin],
                component: MultigestAdministrationComponent
            },
            {
                path: 'administration/registeredMails',
                canActivate: [AppGuardAdmin],
                component: RegisteredMailListComponent
            },
            {
                path: 'administration/registeredMails/new',
                canActivate: [AppGuardAdmin],
                component: RegisteredMailComponent
            },
            {
                path: 'administration/registeredMails/:id',
                canActivate: [AppGuardAdmin],
                component: RegisteredMailComponent
            },
            ...
            {
                path: 'administration/connections/sso',
                canActivate: [AppGuardAdmin],
                component: SsoAdministrationComponent
            },
            {
                path: 'administration/attachments/types',
                canActivate: [AppGuardAdmin],
                component: AttachmentTypesAdministrationComponent
            },
            {
                path: 'administration/attachments/types/new',
                canActivate: [AppGuardAdmin],
                component: AttachmentTypeAdministrationComponent
            },
            {
                path: 'administration/attachments/types/:id',
                canActivate: [AppGuardAdmin],
                component: AttachmentTypeAdministrationComponent
            },
            ...
            {
                path: 'administration/mercure/contacts',
                canActivate: [AppGuardAdmin],
                component: LadContactsManagementComponent
            },
            {
                path: 'administration/mercure/webservice',
                canActivate: [AppGuardAdmin],
                component: MwsAdministrationComponent
            },
            {
                path: 'administration/mercure/webservice/listDocs',
                canActivate: [AppGuardAdmin],
                component: MwsListDocsComponent
            },
            {
                path: 'administration/mercure/webservice/monitoring',
                canActivate: [AppGuardAdmin],
                component: MwsMonitoringComponent
            },
            { path: 'administration/folders', canActivate: [AppGuardAdmin], component: FolderAdministrationComponent },
            {
                path: 'administration/connections/proconnect',
                canActivate: [AppGuardAdmin],
                component: ProConnectAdministrationComponent
            },
            {
                path: 'administration/goodflag',
                canActivate: [AppGuardAdmin],
                component: GoodflagListAdministrationComponent
            },
            {
                path: 'administration/goodflag/new',
                canActivate: [AppGuardAdmin],
                component: GoodflagAdministrationComponent
            },
            {
                path: 'administration/goodflag/:id',
                canActivate: [AppGuardAdmin],
                component: GoodflagAdministrationComponent
            }
        ]),
