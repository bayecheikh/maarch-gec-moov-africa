...
} from './basket/basket-administration.component';
...
} from './contact/list/contacts-list-administration.component';
...
} from './doctype/doctypes-administration.component';
import {
    EntitiesAdministrationComponent,
    EntitiesAdministrationRedirectModalComponent
} from './entity/entities-administration.component';
...
} from './group/groups-administration.component';
...
} from './template/template-administration.component';
import {
    TemplateFileEditorModalComponent
} from './template/templateFileEditorModal/template-file-editor-modal.component';
...
} from './user/user-administration.component';
...
} from './user/redirect-modal/users-administration-redirect-modal.component';
...
} from '@appRoot/administration/parameter/maarchToMaarch/maarch-to-maarch-parameters.component';
...
import { UserAdministrationAccesTokenComponent } from './user/access-token/user-administration-access-token.component';
import {
    ProConnectAdministrationComponent
} from "@appRoot/administration/connection/proConnect/proconnect-administration.component";
import {
    GoodflagListAdministrationComponent
} from "@appRoot/administration/goodflag/list/goodflag-list-administration.component";
import { GoodflagAdministrationComponent } from './goodflag/page/goodflag-administration.component';
import { ConsentPageComponent } from './goodflag/consent-page/consent-page.component';
import { SignatureProfileComponent } from './goodflag/signature-profile/signature-profile.component';
