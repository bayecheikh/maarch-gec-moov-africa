...
export class AdministrationService {
    ...
    getAdminConnectionsSubMenus(): { icon: string, route: string, label: string, current: boolean }[] {
        const adminConnectionsSubMenus: { icon: string, route: string, label: string, current: boolean }[] = [
            {
                icon: 'fas fa-users-cog',
                route: '/administration/connections/sso',
                label: this.translate.instant('lang.sso'),
                current: this.router.url.includes('sso')
            },
            {
                icon: 'fas fa-users-cog',
                route: '/administration/connections/proconnect',
                label: this.translate.instant('lang.proConnect'),
                current: this.router.url.includes('proconnect')
            }
        ];

        return adminConnectionsSubMenus;
    }
}
