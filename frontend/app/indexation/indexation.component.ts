...
} from '@appRoot/attachments/indexation/indexation-attachments-list.component';
...
export class IndexationComponent implements OnInit, OnDestroy {
    ...
    attachmentsListPanelOpened: boolean = false;
    ...
    ngOnInit(): void {
        ...
        this.headerService.sideBarButton = {
            icon: 'fa fa-home',
            label: this.translate.instant('lang.backHome'),
            route: '/home'
        };
        ...
        if (this.indexingForm.isValidForm() && this.appIndexationAttachmentsList.isValid()) {
            ...
            this.appDocumentViewer.getFile().pipe(
                ...
                tap((data: any) => {
                    ...
                    formatdatas['templateId'] = this.appDocumentViewer.templateId;
    ...
    selectAction(action: ActionInterface) {
