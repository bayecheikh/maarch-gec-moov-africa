...
export class SendMultigestActionComponent implements OnInit {
    ...
    checkMultigest() {
        ...
        return new Promise((resolve) => {
            this.http.post('../rest/resourcesList/users/' + this.data.userId + '/groups/' + this.data.groupId + '/baskets/' + this.data.basketId + '/actions/' + this.data.action.id + '/checkSendMultigest', { resources: this.data.resIds }).pipe(
                tap((data: any) => {
