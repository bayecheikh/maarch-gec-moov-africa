...
export interface ToolsListButtonsInterface {
    id: string;
    label: string;
    icon: string;
    allowedSources: string[];
    hasCurrentUserPrivilege: boolean;
    click: () => void;
}
...
export class ToolsListComponent {
    ...
    toolsListButtons: ToolsListButtonsInterface[] = [
        ...
        },
        {
            ...
            icon: 'fa fa-print',
            allowedSources: ['basket', 'search'],
            hasCurrentUserPrivilege: this.privilegesService.hasCurrentUserPrivilege('print_folder_doc'),
