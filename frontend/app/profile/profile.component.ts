...
export class ProfileComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.http.get('../rest/currentUser/profile')
            .subscribe((data: any) => {
                ...
                this.user.signatureSubstitutes = data.signature_substitutes ?? [];
                this.loading = false;
            });
    }
    ...
    delBasketRedirection(basket: any, i: number) {
        const dialogRef = this.dialog.open(ConfirmComponent, {
            ...
            disableClose: true,
            data: {
                title: `${this.translate.instant('lang.deleteRedirection')}`,
    ...
    delBasketAssignRedirection(basket: any, i: number) {
        const dialogRef = this.dialog.open(ConfirmComponent, {
            ...
            disableClose: true,
            data: {
                title: `${this.translate.instant('lang.deleteAssignation')}`,
                msg: this.translate.instant('lang.confirmAction')
            }
        });
        dialogRef.afterClosed().pipe(
