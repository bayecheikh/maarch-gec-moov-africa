...
export class CriteriaToolComponent implements OnInit {
    ...
    infoFields: { id: number, desc: string }[] = [
        {
            id: 1,
    ...
    async ngOnInit(): Promise<void> {
        ...
        } else if (this.currentParam?.target === 'fullText' && !this.functions.empty(this.currentParam.value)) {
            this.criteriaSearchService.updateListsPropertiesCriteria({ fulltext: { values: this.currentParam.value } });
        }
    ...
    getFilterControl(): UntypedFormControl {
        return this.searchCriteria;
    }

    getFilteredCriterias(): Observable<string[]> {
    ...
    getCurrentCriteriaValues(): void {
        ...
        if (!this.functions.empty(this.currentParam?.target) && !this.functions.empty(this.currentParam.value)) {
            ...
            if (this.currentParam.target === 'fullText') {
                this.criteriaSearchService.updateListsPropertiesCriteria({ fulltext: { values: this.currentParam.value } });
            }
        }
    ...
    getLabelValue(identifier: string, value: any): string {
    ...
    getFormatLabel(identifier: string, value: any): string {
    ...
    resetCriteria(criteriaId: string, value: any, refresh: boolean = true): void {
        if (criteriaId !== 'meta') {
    ...
    displayInfoSearch(infoSearchNumber: number): boolean {
    ...
    getBadgesInfoField(field: any): number[] {
        const badges = [];
    ...
    set_meta_field(value: any): void {
        this.searchTermControl.setValue(value);
    }

    set_doctype_field(elem: any): Promise<boolean> {
    ...
    set_priority_field(elem: any): Promise<boolean> {
        return new Promise((resolve) => {
    ...
    set_status_field(elem: any): Promise<boolean> {
        return new Promise((resolve) => {
    ...
    set_category_field(elem: any): Promise<boolean> {
        return new Promise((resolve) => {
    ...
    set_attachment_type_field(elem: any): Promise<boolean> {
        elem.values = [];
        return new Promise((resolve) => {
    ...
    set_groupSign_field(elem: any): Promise<boolean> {
        return new Promise((resolve) => {
    ...
    set_destination_field(elem: any): Promise<boolean> {
        elem.values = [];
        return new Promise((resolve) => {
    ...
    set_initiator_field(elem: any): Promise<boolean> {
        elem.values = [];
        return new Promise((resolve) => {
            this.http.get('../rest/indexingModels/entities').pipe(
                tap((data: any) => {
    ...
    set_registeredMail_issuingSite_field(elem: any): Promise<boolean> {
        return new Promise((resolve) => {
    ...
    set_senderDepartment_field(elem: any): Promise<boolean> {
        return new Promise((resolve) => {
    ...
    deleteSearchTemplate(id: number, listFilter: any): void {
        const dialogRef = this.dialog.open(
            ConfirmComponent,
            {
                panelClass: 'maarch-modal',
    ...
    selectSearchTemplate(searchTemplate: any, openPanel: boolean = true): void {
