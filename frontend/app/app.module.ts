...
} from './actions/disabled-basket-persistence-action/disabled-basket-persistence-action.component';
import {
    EnabledBasketPersistenceActionComponent
} from './actions/enabled-basket-persistence-action/enabled-basket-persistence-action.component';
...
} from './actions/visa-reject-back-to-previous-action/reject-visa-back-to-previous-action.component';
...
} from './actions/update-acknowledgement-send-date-action/update-acknowledgement-send-date-action.component';
import {
    CreateAcknowledgementReceiptActionComponent
} from './actions/create-acknowledgement-receipt-action/create-acknowledgement-receipt-action.component';
...
} from './actions/update-departure-date-action/update-departure-date-action.component';
import {
    SendExternalSignatoryBookActionComponent
} from './actions/send-external-signatory-book-action/send-external-signatory-book-action.component';
import {
    SendExternalNoteBookActionComponent
} from './actions/send-external-note-book-action/send-external-note-book-action.component';
import {
    MaarchParaphComponent
} from './actions/send-external-signatory-book-action/maarch-paraph/maarch-paraph.component';
import { SignaturePositionComponent } from './visa/signature-position/signature-position.component';
import { DateOptionModalComponent } from './visa/signature-position/dateOption/date-option-modal.component';
...
} from './actions/redirect-initiator-entity-action/redirect-initiator-entity-action.component';
import {
    closeMailWithAttachmentsOrNotesActionComponent
} from './actions/close-mail-with-attachments-or-notes-action/close-mail-with-attachments-or-notes-action.component';
import {
    SendSignatureBookActionComponent
} from './actions/visa-send-signature-book-action/send-signature-book-action.component';
import {
    ContinueAvisCircuitActionComponent
} from './actions/avis-continue-circuit-action/continue-avis-circuit-action.component';
...
} from './actions/avis-parallel-validate-action/validate-avis-parallel-action.component';
...
} from './actions/save-registered-mail-action/save-registered-mail-action.component';
import {
    SaveAndIndexRegisteredMailActionComponent
} from './actions/save-and-index-registered-mail-action/save-and-index-registered-mail-action.component';
import {
    SaveAndPrintRegisteredMailActionComponent
} from './actions/save-and-print-registered-mail-action/save-and-print-registered-mail-action.component';
import {
    PrintRegisteredMailActionComponent
} from './actions/print-registered-mail-action/print-registered-mail-action.component';
...
} from './actions/send-to-record-management-action/send-to-record-management.component';
import {
    CheckReplyRecordManagementComponent
} from './actions/check-reply-record-management-action/check-reply-record-management.component';
import {
    ResetRecordManagementComponent
} from './actions/reset-record-management-action/reset-record-management.component';
import {
    CheckAcknowledgmentRecordManagementComponent
} from './actions/check-acknowledgment-record-management-action/check-acknowledgment-record-management.component';
...
} from './sentResource/sent-numeric-package-page/sent-numeric-package-page.component';
...
} from './administration/indexingModel/valuesSelector/values-selector.component';
...
} from './indexation/private-indexing-model/add-private-indexing-model-modal.component';
...
} from './login/passwordModification/password-modification.component';
...
} from './administration/indexingModel/redirectIndexingModel/redirect-indexing-model.component';
...
import { MaarchSbContentComponent } from './signatureBook/content/signature-book-content.component';
...
} from './visa/externalVisaWorkflow/createExternalUser/create-external-user.component';
...
} from './profile/other-plugin/configuration/addin-outlook-configuration-modal.component';
...
} from './registeredMail/acknowledgement-reception/acknowledgement-reception.component';
import {
    CheckSaeInterconnectionComponent
} from './administration/parameter/other/checkSaeInterconnection/check-sae-interconnection.component';
import {
    ContactSearchModalComponentComponent
} from './administration/contact/page/form/contactSearchModal/contact-search-modal.component';
...
} from './actions/visa-continue-circuit-action/new-signature-book/continue-visa-circuit-action-new-sb.component';
import {
    ContinueVisaCircuitActionComponent
} from './actions/visa-continue-circuit-action/continue-visa-circuit-action.component';
import { RagtimeBridgeComponent } from "@plugins/ragtime/ragtime-bridge.component";
...
import { RagtimeButtonComponent } from "@plugins/ragtime/ragtime-button/ragtime-button.component";
import { DashboardResumeComponent } from "@appRoot/dashboard-resume/dashboard-resume.component";
import {
    MaarchSbInformationComponent
} from "@appRoot/signatureBook/content/fileInformationHeader/signature-book-information.component";
import { EditorManagerComponent } from "@appRoot/editor/editor-manager.component";
import { EditorManagerModalComponent } from "@appRoot/editor/modal/editor-manager-modal.component";
import { JavaEditorComponent } from "@plugins/java-editor/java-editor.component";
import { WelcomeMessageComponent } from "@appRoot/home/welcome-message/welcome-message.component";
import { DelegatedUsersComponent } from './profile/parameters/delegated-users/delegated-users.component';
import { AddUserEntityAsCopyActionComponent } from './actions/add-user-entity-as-copy/add-user-entity-as-copy.component';
import { BuildCacheService } from '@service/cache/build-cache.service';
import {
...
/**
 * Angular APP_INITIALIZER factory function that checks for application build changes
 * @param buildCacheService Service handling build cache verification
 * @returns A function that returns a Promise to verify build changes on app startup
 */
export function initApp(buildCacheService: BuildCacheService) {
    // Returns an arrow function that triggers build verification
    return () => buildCacheService.initBuildCheck();
}
...
@NgModule({
    ...
    declarations: [
        ...
        ContinueVisaCircuitActionNewSbComponent,
        ContinueVisaCircuitActionComponent,
        RagtimeBridgeComponent,
        RagtimeButtonComponent,
        ResourceToolbarComponent,
        ResourceToolbarComponent,
        DashboardResumeComponent,
        EditorManagerComponent,
        EditorManagerModalComponent,
        JavaEditorComponent,
