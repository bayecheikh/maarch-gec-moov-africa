...
import { ActionPagesInterface } from '@models/actions.model';


@Injectable()
export class ActionPagesService {

    private actionPages: ActionPagesInterface[] = [
        {
            'id': 'redirect',
        ...
        {
            'id': 'addUserEntityAsCopy',
            'label': this.translate.instant('lang.addUserEntityAsCopy'),
            'name': 'addUserEntityAsCopy',
            'component': 'addUserEntityAsCopyAction',
            'category': 'diffusionList',
            'description': this.translate.instant('lang.addUserEntityAsCopy')
        }
    ];
